    ...
    if (is_aligned(p1, sizeof(dfloat)) && is_aligned(p2, sizeof(dfloat)) &&                    \
      ...
      if (s1 == sizeof(dfloat) && s2 == sizeof(dfloat) && s3 == sizeof(dfloat)) {              \
        if ((n >= num_pack) &&                                                                 \
          ...
          if (p1 == p3) {                                                                      \
            for (i = 0; i < cnt; i++) {                                                        \
              ((dfloat*)p1)[i] = m_mul(((dfloat*)p1)[i], ((dfloat*)p2)[i]);                    \
            }                                                                                  \
          } else {                                                                             \
            for (i = 0; i < cnt; i++) {                                                        \
              ((dfloat*)p3)[i] = m_mul(((dfloat*)p1)[i], ((dfloat*)p2)[i]);                    \
            }                                                                                  \
          }                                                                                    \
                                                                                               \
          cnt_simd_loop = (n - i) % num_pack;                                                  \
        ...
        if (s2 == 0) {                                                                         \
          if (s1 == sizeof(dfloat) && s3 == sizeof(dfloat)) {                                  \
            ...
            if ((n >= num_pack) &&                                                             \
              ...
              if (p1 == p3) {                                                                  \
                for (; i < cnt; i++) {                                                         \
                  ((dfloat*)p1)[i] = m_mul(((dfloat*)p1)[i], *(dfloat*)p2);                    \
                }                                                                              \
              } else {                                                                         \
                for (; i < cnt; i++) {                                                         \
                  ((dfloat*)p3)[i] = m_mul(((dfloat*)p1)[i], *(dfloat*)p2);                    \
                }                                                                              \
              }                                                                                \
                                                                                               \
              cnt_simd_loop = (n - i) % num_pack;                                              \
            ...
            for (i = 0; i < n; i++) {                                                          \
              *(dfloat*)p3 = m_mul(*(dfloat*)p1, *(dfloat*)p2);                                \
              p1 += s1;                                                                        \
              p3 += s3;                                                                        \
            }                                                                                  \
          }                                                                                    \
          ...
          if (p1 == p3) {                                                                      \
            for (i = 0; i < n; i++) {                                                          \
              *(dfloat*)p1 = m_mul(*(dfloat*)p1, *(dfloat*)p2);                                \
              p1 += s1;                                                                        \
              p2 += s2;                                                                        \
            }                                                                                  \
          } else {                                                                             \
